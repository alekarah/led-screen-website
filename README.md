...
- 🖼️ Система оптимизации изображений с автоматической генерацией thumbnails
...
- 🖼️ **Оптимизация изображений**: автогенерация thumbnails (400×300, 1200×900) при загрузке с настраиваемым кроппингом
...
**Инфраструктура:** Beget VPS, Ubuntu 22.04, PostgreSQL 15, Nginx + SSL, systemd service

Подробнее: [docs/OPERATIONS_GUIDE.md](docs/OPERATIONS_GUIDE.md)
