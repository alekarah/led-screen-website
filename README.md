...
**Unit тесты:** 150 автоматических тестов (handlers 34.4%, middleware 100%)
- Middleware 100%, Admin Auth, Admin CRM, Admin Projects, Map Points, Helpers, Telegram API, SEO
```bash
