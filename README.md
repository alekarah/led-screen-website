...
**Unit тесты:** 176 автоматических тестов (handlers 40.4%, middleware 100%)
- Middleware 100%, Admin Auth, Admin CRM, Admin Projects, Admin Prices CRUD, Map Points, Helpers, Telegram API, SEO
```bash
